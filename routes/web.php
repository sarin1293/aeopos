...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('attendant', 'AttendantController@index');
    Route::get('attendant/create', 'AttendantController@create');
    Route::get('attendant/{id}', 'AttendantController@edit');
    Route::post('attendant', 'AttendantController@store');
    Route::put('attendant/{id}', 'AttendantController@update');
    Route::delete('attendant/{id}', 'AttendantController@delete');
    
    Route::get('salary', 'SalaryController@index');
    Route::get('salary/create', 'SalaryController@create');
    Route::get('salary/{id}', 'SalaryController@edit');
    Route::post('salary', 'SalaryController@store');
    Route::put('salary/{id}', 'SalaryController@update');
    Route::delete('salary/{id}', 'SalaryController@delete');
